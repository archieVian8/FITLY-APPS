...
public class RecordFoodActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onResume() {
        ...
        if (!intent.getStringExtra("bfoto").equals("")) { // If there's a valid resource ID
            Glide.with(this)
                    .load(Base64.decode(intent.getStringExtra("bfoto"), Base64.DEFAULT))
